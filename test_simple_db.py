...
class TestMusicDatabase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        albums = [
            ...
            ('Until We Have Faces', 'Red', '2/1/2011', 'Essential Records',
                'CD'),
    ...
    def test_updating_artist(self):
        ...
        expected = [
            ('Until We Have Faces', 'Redder', '2/1/2011', 'Essential Records',
                'CD')
        ]
        self.assertEqual(expected, actual)
    
    def test_artist_does_not_exit(self):
